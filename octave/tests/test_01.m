...
for stop_after_iter = [10];
    ...
    print_plot(cstrcat('./divcom_vs_dist_01_stop', num2str(stop_after_iter), '_dist', num2str(disturb_iter), '_tc'));
    ...
    print_plot(cstrcat('./divcom_vs_dist_01_stop', num2str(stop_after_iter), '_dist', num2str(disturb_iter), '_ntc'));
    ...
    print_plot(cstrcat('./divw_vs_dist_01_stop', num2str(stop_after_iter), '_dist', num2str(disturb_iter), '_tc'));
    ...
    print_plot(cstrcat('./divw_vs_dist_01_stop', num2str(stop_after_iter), '_dist', num2str(disturb_iter), '_ntc'));
end
