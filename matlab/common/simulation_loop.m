...
while (1)
    ...
    %% OPTIMIZATION 1: ROTATION ANGLE
    [H_rot, q_rot] = form_objective_rot (mpc_rot, S0v_rot, Uv, weightsMatrix, D1, D2, L, twistMatrix_cm_cam, ...
                                         mpc_state.cstate(2),mpc_state.cstate(5),errors, Nlm);
    ...
    %[H, q] = addVisualServoingToObjective(mpc, H, q, Du, Dv, errors, ...
    %                                      weightsMatrix, S0v, Uv, Nlm, delta);
    
    [H, q] = addVisualServoingToTransObjective(H, q, mpc, S0v, Uv,...
                                               weightsMatrix, D1, D2, ...
                                               L, twistMatrix_cm_cam, ...
                                               mpc_state_rot.cstate(2), errors, Nlm, delta);
