function [H_rot, q_rot, S0p_rot, Up] = form_objective_rot (mpc_rot, mpc_state_rot, S0p_rot, Up, S0v_rot, Uv, D1, D2)
    ...
    H_rot = mpc_rot.alpha*Up'*D1Sqr*Up + mpc_rot.gamma*Up'*D2Sqr*Up;
    q_rot = mpc_rot.alpha*Up'*D1'*(D1*S0p_rot - mpc_state_rot.ref_pos) + mpc_rot.gamma*Up'*D2'*(D2*S0p_rot - mpc_state_rot.ref_pos);
